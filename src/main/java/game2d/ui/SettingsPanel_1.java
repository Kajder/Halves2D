...
public class SettingsPanel_1 extends SettingsPanel {
    ...
    private Hashtable<Integer, JLabel> labelsShotForce, labelsMapAngular, labelsMapRestitution, labelsMapDensity, labelsMapContact, labelsMapWalk, labelsMapSprint;
    ...
    public SettingsPanel_1(Handler handler) {
        ...
        //for shot force(s1)
        labelsShotForce = new Hashtable<>();
        labelsShotForce.put(2000, new JLabel("2000"));
        labelsShotForce.put(4000, new JLabel("4000"));
        labelsShotForce.put(6000, new JLabel("6000"));
        labelsShotForce.put(8000, new JLabel("8000"));
        labelsShotForce.get(2000).setForeground(Color.WHITE);
        labelsShotForce.get(4000).setForeground(Color.WHITE);
        labelsShotForce.get(6000).setForeground(Color.WHITE);
        labelsShotForce.get(8000).setForeground(Color.WHITE);
        //for angular velocity(s2)
        ...
        //CREATING SLIDERS
        s1 = new SliderPanel(handler, labelS1, toolTipS1, 2000, 8000, handler.getParameters().getCustomParameters().get("maxForce").intValue());
        ...
        s1.setLabelTable(labelsShotForce);
