...
public class GameState extends State {
  ...
  public void render(Graphics g) {
    if ((tick > 0) && (tick <= handler.getFPS())) {
      g.drawImage(Assets.startBoard[0], handler.getWidth() / 2 - 210 / 2, handler.getHeight() / 2 - 144 / 2, 210, 144, null);
    }
    if ((tick > (handler.getFPS())) && (tick <= 2 * (handler.getFPS()))) {
      g.drawImage(Assets.startBoard[1], handler.getWidth() / 2 - 210 / 2, handler.getHeight() / 2 - 144 / 2, 210, 144, null);
    }
    if ((tick > 2 * (handler.getFPS())) && (tick <= 3 * (handler.getFPS()))) {
      g.drawImage(Assets.startBoard[2], handler.getWidth() / 2 - 210 / 2, handler.getHeight() / 2 - 144 / 2, 210, 144, null);
    }
    if ((tick > 3 * (handler.getFPS())) && (tick <= 3.5 * (handler.getFPS()))) {
      g.drawImage(Assets.startBoard[3], handler.getWidth() / 2 - 210 / 2, handler.getHeight() / 2 - 144 / 2, 210, 144, null);
    }
...
//score indicators
      ...
      if (player1.getScore() == 0) {
        g.drawImage(Assets.balls0, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 96 / 100, 80, 16, null);
      }
      if (player1.getScore() == 1) {
        g.drawImage(Assets.balls1, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 96 / 100, 80, 16, null);
      }
      if (player1.getScore() == 2) {
        g.drawImage(Assets.balls2, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 96 / 100, 80, 16, null);
      }
      if (player1.getScore() == 3) {
        g.drawImage(Assets.balls3, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 96 / 100, 80, 16, null);
      }
      if (player1.getScore() == 4) {
        g.drawImage(Assets.balls4, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 96 / 100, 80, 16, null);
      }
      if (player1.getScore() >= 5) {
        g.drawImage(Assets.balls5, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 96 / 100, 80, 16, null);
      }
      if ((player1.getScore() >= 5) && (player2.getScore() < 5)) {
        g.drawImage(Assets.cup, handler.getWidth() / 2 - 50 / 2, handler.getHeight() * 745 / 1000, 50, 55, null);
      }
      if (player1.getScore() >= 5) {
        k++;
        if (k >= (3 * handler.getFPS())) {
          endMatch();
        }
      }
      ...
      if (player2.getScore() == 0) {
        g.drawImage(Assets.balls0, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 12 / 1000, 80, 16, null);
      }
      if (player2.getScore() == 1) {
        g.drawImage(Assets.balls1, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 12 / 1000, 80, 16, null);
      }
      if (player2.getScore() == 2) {
        g.drawImage(Assets.balls2, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 12 / 1000, 80, 16, null);
      }
      if (player2.getScore() == 3) {
        g.drawImage(Assets.balls3, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 12 / 1000, 80, 16, null);
      }
      if (player2.getScore() == 4) {
        g.drawImage(Assets.balls4, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 12 / 1000, 80, 16, null);
      }
      if (player2.getScore() >= 5) {
        g.drawImage(Assets.balls5, handler.getWidth() / 2 - 80 / 2, handler.getHeight() * 12 / 1000, 80, 16, null);
      }
      if ((player2.getScore() >= 5) && (player1.getScore() < 5)) {
        g.drawImage(Assets.cup, handler.getWidth() / 2 - 50 / 2, handler.getHeight() * 16 / 100, 50, 55, null);
      }
      if (player2.getScore() >= 5) {
        k++;
        if (k >= (3 * handler.getFPS())) {
