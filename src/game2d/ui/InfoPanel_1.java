...
public class InfoPanel_1 extends SettingsPanel {
    ...
    public InfoPanel_1(Handler handler){
        ...
        upperString="<html><p align=\"justify\">Hello there! I am £ukasz Kajder, the author of Halves 2D game. <br>" +
                "I sincerely hope you will have at least as much fun playing the game as I had creating it.<br>" +
